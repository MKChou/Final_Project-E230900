...
# --- 設定 ---
COM_PORT = 'COM5'  # 請確認這是你的 STM32 Port
BAUD_RATE = 9600
...
def read_serial_data():
    ...
    try:
        ...
        # print(f"成功連接到 {COM_PORT}")  # 已禁用終端輸出
    except Exception as e:
        # print(f"無法連接 Serial: {e}")  # 已禁用終端輸出
        # print("請檢查 Port 是否正確，或是否被其他程式佔用。")  # 已禁用終端輸出
        return

    # print("開始讀取數據...按 Ctrl+C 停止")  # 已禁用終端輸出
    # print("=" * 80)  # 已禁用終端輸出
